        ...
        <div className="grid gap-14 xl:grid-cols-[0.96fr_1.04fr] xl:items-center">
          <div>
            ...
            <p className="text-lg md:text-[1.18rem] text-joa-text leading-8 mb-8 max-w-2xl">
              JoaLLM brings chat, retrieval, notebooks, workflows, model choice, and governance into one connected
              product so teams can move from question to verified output without stitching tools together.
            </p>
