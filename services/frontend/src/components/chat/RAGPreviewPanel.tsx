...
import { Search, FileText, TrendingUp, AlertCircle, Eye, EyeOff, Loader2, Layers } from 'lucide-react';
    ...
    <div className="mb-3 bg-gradient-to-r from-purple-50 to-blue-50 border border-purple-200 rounded-lg overflow-hidden">
      ...
      <div className="flex items-center justify-between px-4 py-2 bg-white bg-opacity-60 border-b border-purple-200">
        <div className="flex items-center gap-2">
          ...
          <span className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded text-xs font-medium bg-purple-100 text-purple-700" title="Combines semantic (vector) and keyword matching for broader recall">
        ...
        {isSearching ? (
          <div className="flex items-center justify-center py-8">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">Hybrid searching documents...</p>
            </div>
          </div>
        ) : error ? (
                  ...
                  {result.matchingChunks.map((chunk, chunkIndex) => (
                    <div key={chunkIndex} className="bg-gray-50 rounded p-2">
                      <div className="flex items-center justify-between mb-1">
                        ...
                        <span className={`px-1.5 py-0.5 rounded text-xs font-medium ${getScoreColor(chunk.score)}`} title="Combined vector + keyword relevance score">
