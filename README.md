...
Institutional knowledge acquisition, relationship intelligence, and guided AI workspaces — deployed as a multi-service monorepo on Railway.

Formerly branded JoaLLM Platform; package scopes may still use `@joallm/*` internally.
