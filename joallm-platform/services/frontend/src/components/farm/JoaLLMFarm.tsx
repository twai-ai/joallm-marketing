      ...
      <div className="bg-white border-b border-gray-200 px-6 py-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">{PRODUCT_LABELS.models}</h1>
              <p className="text-gray-600 mt-1">Explore available AI models and compare fit by provider, speed, and quality</p>
            </div>
