...
-- This populates the models table with all available models

-- Clear existing data (optional - remove if you want to keep existing data)
-- DELETE FROM models;

-- Insert all models from the frontend LLMContext
...
-- Update the sequence for sort_order if needed
-- This ensures proper ordering of models
