...
export class ValidationUtils {
  ...
  // File validation - Updated to use centralized fileValidation utility
  static validateFile(file: File): ValidationResult {
    ...
    // Import at top: import { validateFile as validateFileFormat } from './fileValidation';
    // For now, inline the validation logic to maintain backward compatibility
